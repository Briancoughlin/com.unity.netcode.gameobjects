...
namespace IO.Swagger.Api
{
    ...
    public interface IEnvironmentApi : IApiAccessor
    {
        ...
        ApiResponse<ApiResponse> SetHeaterStateWithHttpInfo (string zoneId, string state);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse> SetHeaterStateAsync (string zoneId, string state);
        ...
        System.Threading.Tasks.Task<ApiResponse<ApiResponse>> SetHeaterStateAsyncWithHttpInfo (string zoneId, string state);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class EnvironmentApi : IEnvironmentApi
    {
        ...
        /// <param name="state"></param>
        /// <returns>ApiResponse</returns>
        public ApiResponse SetHeaterState (string zoneId, string state)
        {
             ApiResponse<ApiResponse> localVarResponse = SetHeaterStateWithHttpInfo(zoneId, state);
             return localVarResponse.Data;
        }
        ...
        /// <param name="state"></param>
        /// <returns>ApiResponse of ApiResponse</returns>
        public ApiResponse< ApiResponse > SetHeaterStateWithHttpInfo (string zoneId, string state)
        {
            // verify the required parameter 'zoneId' is set
            if (zoneId == null)
        ...
        /// <param name="state"></param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse> SetHeaterStateAsync (string zoneId, string state)
        {
             ApiResponse<ApiResponse> localVarResponse = await SetHeaterStateAsyncWithHttpInfo(zoneId, state);
             return localVarResponse.Data;
        ...
        /// <param name="state"></param>
        /// <returns>Task of ApiResponse (ApiResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ApiResponse>> SetHeaterStateAsyncWithHttpInfo (string zoneId, string state)
        {
            // verify the required parameter 'zoneId' is set
            if (zoneId == null)
                throw new ApiException(400, "Missing required parameter 'zoneId' when calling EnvironmentApi->SetHeaterState");
